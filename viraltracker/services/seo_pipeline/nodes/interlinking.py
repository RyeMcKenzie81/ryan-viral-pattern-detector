    ...
    async def run(
        ...
        try:
            ...
            auto_result = service.auto_link_article(
                str(ctx.state.article_id),
                push_to_cms=bool(ctx.state.cms_article_id),
            ...
            logger.info(f"Interlinking complete: {suggestion_count} suggested, {links_added} auto-linked")
