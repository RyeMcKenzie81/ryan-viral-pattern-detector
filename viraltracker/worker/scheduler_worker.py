...
JOB_TYPE_PAGE_SLUGS = {
    'ad_creation': 'ad_history',
    'ad_creation_v2': 'ad_history',
    'meta_sync': 'ad_performance',
    'scorecard': 'ad_performance',
    'template_scrape': 'template_queue',
    'template_approval': 'template_queue',
    'congruence_reanalysis': 'congruence_insights',
    'ad_classification': 'hook_analysis',
    'asset_download': 'ad_scheduler',
    'competitor_scrape': 'competitor_research',
    'reddit_scrape': 'reddit_research',
    'amazon_review_scrape': 'ad_scheduler',
    'ad_intelligence_analysis': 'hook_analysis',
    'analytics_sync': 'ad_performance',
    'seo_status_sync': 'seo_dashboard',
    'creative_genome_update': 'ad_scheduler',
    'genome_validation': 'ad_scheduler',
    'winner_evolution': 'experiments',
        ...
        for idx, template in enumerate(templates):
            ...
            try:
                ...
                result = await run_ad_creation_v2(
                    ...
                    user_selected_image_ids=params.get('user_selected_image_ids'),
                    persona_id=params.get('persona_id'),
