    ...
    SECTIONS = [
        ...
        },
        {
            ...
            "opt_in": [
                ...
                (FeatureKey.SEO_DASHBOARD, "SEO Dashboard"),
                (FeatureKey.SEO_KEYWORD_RESEARCH, "Keyword Research"),
                (FeatureKey.SEO_ARTICLE_WRITER, "Article Writer"),
                (FeatureKey.SEO_ARTICLE_PUBLISHER, "Article Publisher"),
                (FeatureKey.SEO_CLUSTER_MANAGER, "SEO Clusters"),
                (FeatureKey.SEO_WORKFLOW, "SEO Workflow"),
                (FeatureKey.SEO_CONTENT_POLICIES, "Content Policies"),
                (FeatureKey.SEO_EXCEPTIONS, "Exceptions"),
            ],
        },
        {
