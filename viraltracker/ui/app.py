...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        with st.expander("View Agents (6 total)", expanded=False):
            ...
            **Twitter Agent**
            - Find tweets, outliers, hooks
            - 8 tools

            **TikTok Agent**
            - Videos, hashtags, analytics
            - 5 tools
        ...
        with st.expander("View Services", expanded=False):
            ...
            **Architecture Pattern**
            - Orchestrator Pattern (PydanticAI 1.18.0)
            ...
            **AI Models**
            - Claude Sonnet 4.5: Agent routing & tools
            - Gemini AI: Backup analytics
