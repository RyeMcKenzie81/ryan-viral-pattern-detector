...
### Completed (Checkpoint 006)
- ~~Competitor Research ad scrape → `queue_one_time_job('competitor_scrape')`~~ — new job type + handler, legacy toggle, recent runs display, Pipeline Manager registration
